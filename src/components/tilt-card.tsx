...
/**
 * Interactive 3D tilt card — credit: 21st.dev (tom_ui) "Gravitate" pattern.
 * Pointer position drives rotateX/Y; optional spotlight follows cursor.
 *
 * ponytail: only works on devices with hover (mouse). On touch it stays flat.
 */
