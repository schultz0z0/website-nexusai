...
/**
 * Cinematic Hero — pinned scroll intro. Defaults adapted to Nexus AI
 * (brandName, tagline, card copy, metric, CTA). All visual treatment
 * (iPhone mockup, App Store / Google Play buttons, film grain, deep
 * card, floating badges, mouse parallax) is verbatim from the source
 * spec — that's the point of the cinematic feel.
 */
...
export function CinematicHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Nexus AI</span> entrega agentes
      e plataformas de IA que tiram do caminho da sua equipe tudo que é
      repetitivo, do atendimento à análise.
    </>
  ),
  metricValue = 12,
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/contato" aria-label="Solicitar Proposta" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Solicite sua</div>
              <div className="text-xl font-bold leading-none tracking-tight">Proposta</div>
            </div>
          </a>
          <a href="/processo" aria-label="Ver processo" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Conheça nosso</div>
              <div className="text-xl font-bold leading-none tracking-tight">Processo</div>
            </div>
          </a>
        </div>
      </div>
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        ...
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">NA</div>
                      </div>
