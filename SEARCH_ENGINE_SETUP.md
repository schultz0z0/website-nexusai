...
1. Adicione a propriedade de domínio `solucoes-nexus.tech`.
...
5. Envie `https://solucoes-nexus.tech/sitemap.xml`.
...
1. Adicione `solucoes-nexus.tech` ou importe a propriedade do Google Search Console, se essa opção estiver disponível na conta.
...
3. Envie `https://solucoes-nexus.tech/sitemap.xml`.
4. Confirme que o sitemap também aparece em `https://solucoes-nexus.tech/robots.txt`.
...
- Teste a imagem social em `https://solucoes-nexus.tech/og-image.png` após a publicação.
